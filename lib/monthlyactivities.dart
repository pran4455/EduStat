...
class MonthlyActivitiesScreen extends StatelessWidget {
  final List<Map<String, String>> monthlyActivities = [
    {
      'label': 'Monthly Activities',
      'url': 'https://drive.google.com/drive/folders/1y5Q95eOcrBmnAwGw_C-hEnHbgI5vm8b8?usp=sharing'
    },
  ];
