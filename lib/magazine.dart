...
class MagazineScreen extends StatelessWidget {
  final List<Map<String, String>> magazineOptions = [
    {
      'label': 'Magazine',
      'url': 'https://drive.google.com/drive/folders/1hFxnEAl5hPHPBdRqVSpY5wGqMp4RLpSD?usp=sharing'
    },
  ];
